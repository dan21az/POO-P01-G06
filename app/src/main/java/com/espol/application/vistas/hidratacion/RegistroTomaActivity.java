package com.espol.application.vistas.hidratacion;
...
public class RegistroTomaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGuardar.setOnClickListener(v -> {
            ...
            if (cantStr.isEmpty()) {
                Toast.makeText(this, "Ingrese la cantidad de agua", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            try {
                ...
                controladora.registrarToma(cantidad, String.valueOf(horaSeleccionada), fechaSeleccionada);

                SimpleDateFormat sdf = new SimpleDateFormat("HH:mm");

                Toast.makeText(this,
                        "¡Toma registrada a las " + (sdf.format(horaSeleccionada.getTime())) + "!",
